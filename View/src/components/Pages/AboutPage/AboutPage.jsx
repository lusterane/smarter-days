				...
				<div className='about-page-container'>
					...
					<div className='about-us-container'>
						<div className='sub-container'>
							...
							<div className='sub-container'>
								<p>
									We are a 2 person team (Toby Chow, Richard Team) that loves
								...
								<p>
									...
									the learning experience was definitely valuable to us. If the
									application catches on, we hope to make improvements and see
									where it goes! :)
								</p>
							</div>
						</div>
